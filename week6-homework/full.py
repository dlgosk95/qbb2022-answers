...
in1_fname = '/Users/cmdb/qbb2022-answers/week6-homework/matrix/dCTCF_full.6400.matrix'
in2_fname = '/Users/cmdb/qbb2022-answers/week6-homework/matrix/ddCTCF_full.6400.matrix'
bin_fname = '/Users/cmdb/qbb2022-answers/week6-homework/matrix/6400_bins.bed'
...
minimum_column1 = data1_filtered[0][1]

# print (minimum_column0) ## 343068
# print (minimum_column1) ## 343068
...
ax[0].imshow(empty1, cmap = "magma_r", vmax = 10)
